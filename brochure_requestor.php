...
function br_send_pending_mail($body) {
  $recipient = 'production@xzito.com';
...
add_action('wp_ajax_nopriv_br_get_requested_brochure_data', 'br_get_requested_brochure_data');
add_action('wp_ajax_br_get_requested_brochure_data', 'br_get_requested_brochure_data');
        ...
        <div class="modal-content">
          <form class="form-horizontal" action="<?php the_permalink(); ?>" method="post">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-primary">Request Brochure</button>
            </div>
          </form>
        </div>
      </div>
